...
-- v3.70 private-feature entitlement gate. Client sessions can discover only
-- their own active access; entitlement changes remain server/admin-only.
...
insert into public.private_feature_access (feature_key, user_id, active, granted_by)
select 'schematic_takeoff', admin.user_id, true, admin.user_id
