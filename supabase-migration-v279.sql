-- SpoolMate v2.79 migration.
-- Paste this complete file into a NEW Supabase SQL Editor query and press Run.
...
create function public.set_project_comment_resolved(
...
select 'SpoolMate v2.79 migration complete' as result;
